...
public class Medicamento {
	...
	public Medicamento() {
		...
		dataValidade = LocalDate.now().plusMonths(12); // o default é uma validade de 12 meses.
	}

	public Medicamento(int id, String descricao, float preco, int quantidade, LocalDateTime fabricacao, LocalDate v) {
		setId(id);
	...
	public String toString() {
		return "Medicamento: " + descricao + "   Preço: R$" + preco + "   Quantidade.: " + quantidade + "   Fabricação: "
				+ dataFabricacao  + "   Data de Validade: " + dataValidade;
	}
	
	@Override
	public boolean equals(Object obj) {
		return (this.getID() == ((Medicamento) obj).getID());
	}	
}